...
\addcontentsline{toc}{subsubsection}{Expressions}
\begin{table}[!h]

\caption{\label{tab:appendixbexpressions}Expressions}
\centering
\begin{tabular}{l|l}
\hline
Source & Link\\
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.23\columnwidth}\raggedright\strut
missing data mechanism\strut
\end{minipage} & \begin{minipage}[t]{0.71\columnwidth}\raggedright\strut
Process that governs the relationship between observe data and
probability of missingness\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.23\columnwidth}\raggedright\strut
missing data model\strut
\end{minipage} & \begin{minipage}[t]{0.71\columnwidth}\raggedright\strut
General expression that formalizes the relationship specified by the
missing data mechanism\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.23\columnwidth}\raggedright\strut
missing completely at random (MCAR)\strut
\end{minipage} & \begin{minipage}[t]{0.71\columnwidth}\raggedright\strut
A missing data mechanism in which missingness depends on \(\psi\)
only\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.23\columnwidth}\raggedright\strut
missing at random (MAR)\strut
\end{minipage} & \begin{minipage}[t]{0.71\columnwidth}\raggedright\strut
A missing data mechanism in which missingness depends on \(Y_{obs}\) and
\(\psi\) only\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.23\columnwidth}\raggedright\strut
missing not at random (MNAR)\strut
\end{minipage} & \begin{minipage}[t]{0.71\columnwidth}\raggedright\strut
A missing data mechanism in which missingness depends on \(Y_{obs}\),
\(Y_{mis}\), and \(\psi\)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.23\columnwidth}\raggedright\strut
ignorability\strut
\end{minipage} & \begin{minipage}[t]{0.71\columnwidth}\raggedright\strut
A set of criteria required for imputation models to safely ignore the
parameters of the missing data model \(\psi\). MAR and MCAR are
considered ignorable\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.23\columnwidth}\raggedright\strut
imputation model\strut
\end{minipage} & \begin{minipage}[t]{0.71\columnwidth}\raggedright\strut
An algorithm used to replace missing values in a dataset with plausible
imputations\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
