...
point, no missingness exists in either \(x\) or \(y\).
...
model. The table uses aliases for concepts covered in the
...
{\centering \includegraphics[width=300px]{figure/x-mis-forty-loc-mar} 
...
{\centering \includegraphics[width=300px]{figure/x-mis-forty-bar-mar} 
...
\protect\hyperlink{findings}{Findings}, demonstrates how the nature of
missingness affected the results of linear regression on the mulitply
imputed data.
